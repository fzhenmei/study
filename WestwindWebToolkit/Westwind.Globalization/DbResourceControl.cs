...
namespace Westwind.Globalization
{
    ...
    public class DbResourceControl : CompositeControl
    {
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            if (ShowIconsInitially == ShowLocalizationStates.Show)
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            if (!this.Page.IsPostBack)
            {
                if (this.ShowIconsInitially == ShowLocalizationStates.DontShow)
                    ...
                    this.ShowIcons = DbResourceConfiguration.Current.ShowControlIcons &&
...
function AddHtmlAfterControl(ControlId,HtmlMarkup)
{
    ...
    if (Sibling != null)
     ...
     Ctl.parentNode.appendChild(Insert);
        ...
        [CallbackMethod]
        public Dictionary<string, string> GetResources(string resourceID, string resourceSet)
        {
            DbResourceDataManager manager = new DbResourceDataManager();
            return manager.GetResourceStrings(resourceID, resourceSet);
        }
