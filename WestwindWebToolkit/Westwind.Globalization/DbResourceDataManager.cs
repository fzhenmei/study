...
namespace Westwind.Globalization
{
    ...
    public class DbResourceDataManager
    {
        ...
        public IDictionary GetResourceSet(string CultureName, string ResourceSet)
        {
            ...
            string ResourceFilter = string.Empty;
    ...
    order by ResourceId, LocaleId DESC";
        ...
        public DataTable GetAllResources()
        {
            ...
            Sql = "select ResourceId,Value,LocaleId,ResourceSet,Type,TextFile,BinFile,FileName,Comment from " +
...
@"select resourceId,CAST( MAX( 
	...
	group by ResourceId";
            ...
            return Data.ExecuteTable("TResourceIds", sql,
                                     Data.CreateParameter("@ResourceSet",ResourceSet) ) ;
        }
        ...
        {
            SqlDataAccess Data = new SqlDataAccess(DbResourceConfiguration.Current.ConnectionString);
            return Data.ExecuteTable("TLocaleIds", "select LocaleId,'' as Language from " + DbResourceConfiguration.Current.ResourceTableName + " where ResourceSet=@ResourceSet group by LocaleId",
                                     Data.CreateParameter("@ResourceSet", ResourceSet));
        }
        ...
        public string GetResourceString(string ResourceId, string ResourceSet, string CultureName)
        {
            ...
            object Result = Data.ExecuteScalar("select Value from " + DbResourceConfiguration.Current.ResourceTableName + " where ResourceId=@ResourceId and ResourceSet=@ResourceSet and LocaleId=@LocaleId",
        ...
        public ResourceItem GetResourceItem(string ResourceId, string ResourceSet, string CultureName)
        {
            ...
            using (IDataReader reader =
                           Data.ExecuteReader("select Value,Comment from " + DbResourceConfiguration.Current.ResourceTableName + " where ResourceId=@ResourceId and ResourceSet=@ResourceSet and LocaleId=@LocaleId",
                               Data.CreateParameter("@ResourceId", ResourceId),
                               Data.CreateParameter("@ResourceSet", ResourceSet),
                               Data.CreateParameter("@LocaleId", CultureName)))
            {
        ...
        public Dictionary<string,string> GetResourceStrings(string ResourceId, string ResourceSet)
        {
            ...
            DbDataReader reader = Data.ExecuteReader("select Value,LocaleId from " + DbResourceConfiguration.Current.ResourceTableName + 
        ...
        {
            return this.UpdateOrAdd(ResourceId, Value, CultureName, ResourceSet, Comment, false);
        }
        ...
        /// <param name="ResourceSet"></param>
        /// <param name="Type"></param>
        public int UpdateOrAdd(string ResourceId, object Value, string CultureName, string ResourceSet, string Comment, bool ValueIsFileName)
        {
            if (!this.IsValidCulture(CultureName))
            {
                this.ErrorMessage = "Can't save resource: Invalid culture id passed: " + CultureName;
                return -1;
            }
            
            int Result = 0;
            Result = this.UpdateResource(ResourceId, Value, CultureName, ResourceSet,Comment,ValueIsFileName);
            ...
            Result = this.AddResource(ResourceId, Value, CultureName, ResourceSet,Comment,ValueIsFileName);
        ...
        {
            return this.AddResource(ResourceId, Value, CultureName, ResourceSet, Comment, false);
        }
        ...
        public int AddResource(string ResourceId, object Value, string CultureName, string ResourceSet, string Comment, bool ValueIsFileName)
        {
            ...
            {
                this.ErrorMessage = "No ResourceId specified. Can't add resource";
                return -1;
            }
        ...
        {
            return this.UpdateResource(ResourceId, Value, CultureName, ResourceSet, Comment, false);
        }
        ...
        public int UpdateResource(string ResourceId, object Value, string CultureName, string ResourceSet, string Comment, bool ValueIsFileName)
        {
            ...
            string Sql = "update " + DbResourceConfiguration.Current.ResourceTableName + " set Value=@Value, Type=@Type, BinFile=@BinFile,TextFile=@TextFile,FileName=@FileName, Comment=@Comment where LocaleId=@LocaleId AND ResourceSet=@ResourceSet and ResourceId=@ResourceId";
        ...
        public bool DeleteResource(string ResourceId, string CultureName, string ResourceSet)
        {
            ...
            if (!string.IsNullOrEmpty(CultureName))
                ...
                Result = Data.ExecuteNonQuery("delete from " + DbResourceConfiguration.Current.ResourceTableName + " where ResourceId=@ResourceId and LocaleId=@LocaleId and ResourceSet=@ResourceSet",
                                      Data.CreateParameter("@ResourceId", ResourceId),
                                      Data.CreateParameter("@LocaleId", CultureName),
                                      Data.CreateParameter("@ResourceSet", ResourceSet));
            else
                // If we're deleting the invariant entry - delete ALL of the languages for this key
                Result = Data.ExecuteNonQuery("delete from " + DbResourceConfiguration.Current.ResourceTableName + " where ResourceId=@ResourceId and ResourceSet=@ResourceSet",
                                      Data.CreateParameter("@ResourceId", ResourceId),
                                      Data.CreateParameter("@ResourceSet", ResourceSet));
            ...
            try
            {
                ...
                foreach (DictionaryEntry Entry in ResourceList)
                {
                    if (Entry.Value != null)
                    {
                        int Result = 0;
                        if (DeleteAllResourceFirst)
                            Result = this.AddResource(Entry.Key.ToString(), Entry.Value, CultureName, BaseName,null);
                        else
                            Result = this.UpdateOrAdd(Entry.Key.ToString(), Entry.Value, CultureName, BaseName,null);
        ...
        {
            string script = this.GetResourcesAsJavascriptObject(javaScriptVarName,ResourceSet,null);
