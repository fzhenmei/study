...
function AddResource(keepOpen) {    
    ...
    if ( (ResourceId == null || Value == ResourceId) )
    {
        alert(ResC("NoValueEntered") );
        return;
    }
...
function Translate()
{
    ...
    Callback.Translate(Value, From, To, "BabelFish",
        function(result) { $("#txtBabelFish").val(result); },OnPageError);
}
