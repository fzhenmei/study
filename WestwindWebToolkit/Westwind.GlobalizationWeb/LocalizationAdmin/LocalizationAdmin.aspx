...
<body>    
    ...
    <tr>
        <td valign="top">
            ...
            <asp:TextBox runat="server" ID="txtResSearch"  AccessKey="E" ToolTip="Search (Alt-E)" meta:resourcekey="txtResSearch"
        ...
        <td valign="top"> 
            ...
            <br />
            <br />
            <asp:Button runat="server" ID="btnShowComment" Text="Comment" meta:resourcekey="btnShowComment"  UseSubmitBehavior="false"  onclientClick="$('#panelComment').show(); return false;" 
