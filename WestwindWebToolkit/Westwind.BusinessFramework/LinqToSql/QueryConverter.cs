...
namespace Westwind.BusinessFramework.LinqToSql
{
    ...
    {
        protected BusinessObjectLinq<TEntity, TContext> Business = null;

        protected DataContextSql Context = null;
        ...
        public QueryConverter(BusinessObjectLinq<TEntity, TContext> business, DataContextSql context)
        {
        ...
        public DataTable ToDataTable(object query, string tableName, bool ExecuteWithSchema)
        {
            ...
            DbDataAdapter Adapter = BusinessObjectLinq<TEntity,TContext>.ProviderFactory.CreateDataAdapter();
